...
class CalendarModel extends Model
{
    ...
    {
        $this->query("SELECT tasks.id, tasks.name, tasks.start_date, tasks.end_date, tasks.color, u1.name AS users_name, u1.lastname AS users_lastname, u2.name as user_name, u2.lastname as user_lastname, projects.name as projects_name
                            FROM tasks
